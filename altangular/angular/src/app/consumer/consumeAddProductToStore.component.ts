        ...
        <form (ngSubmit) = "onSubmit()">
            <table class="table" border="1px">
                ...
                <tr *ngFor="let data of reciveData">
                    <td scope="row">{{data.productName}}</a></td>
...
`,
providers:[ServiceAddProductToStore]
})
export class ConsumeAddProductToSystem implements OnInit,ProductInstance, Product, Stores
{
    id : any;
    price : any;
    product : Product;
    ...
    ngOnInit() {
        this.products = {productName : this.productName, productCategory : this.productCategory, productType : this.productType, brand : this.brand, productPriceMax : this.productPriceMax, productPriceMin : this.productPriceMin};
    ...
    constructor(private storage:LocalStorageService, private router : Router, private route : ActivatedRoute, private serviceObject : ServiceAddProductToStore)
    {
    ...
    get()
    {
        this.serviceObject.get_product().subscribe(
            value =>{
    ...
    onSubmit()
    {
        ...
        this.serviceObject.send(this.productInstance, this.user).subscribe(
            value => {
